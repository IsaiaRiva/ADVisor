    ...
    return {
      'en-US': {
        Messages: {
          ...
          AutoFaceIndexerStatsDesc: 'Total of <code>{{FACES_INDEXED}}</code> new faces added to the collection with a total of <code>{{API_COUNT}}</code> Amazon Rekognition IndexFaces API invoked.',
          ...
          ShoppableDesc: '<span class="text-success">New feature:</span> Shoppable metadata detection uses machine learning models to identify apparel items in the content. It then finds similar items in your product catalog stored in Amazon OpenSearch with KNN, a <code>vector store</code>.',
        ...
        Alerts: {
          ...
          // adbreak
          NoAdBreakDetected: 'Unable to find a good slot for ad break',
          // shoppable
